...
public class Ability
{
	...
	public Texture2D GetIcon() {
		if (iconNormal == null) {
			iconNormal = Resources.Load<Texture2D>("Shared/GUI/" + StageManager.currentStage.stageTheme + "." + iconName);
		}
		return iconNormal;
	}
	...
	public Texture2D GetHighlightedIcon() {
		if (iconHighlighted == null) {
			iconHighlighted = Resources.Load<Texture2D>("Shared/GUI/" + StageManager.currentStage.stageTheme + "." + iconName + "_highlighted");
		}
	...
	public Texture2D GetClickedIcon() {
		if (iconClicked == null) {
			iconClicked = Resources.Load<Texture2D>("Shared/GUI/" + StageManager.currentStage.stageTheme + "." + iconName + "_clicked");
		}
		return iconClicked;
	}
}